...

{
    ...
    gen -> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/event_numbers/UL18/electron/workdir_Zprime_Analysis_UL18_unfolding/uhh2.AnalysisModuleRunner.MC.TTToSemiLeptonic_UL18_0.root");
    ...
    // UL 18 Electron 21912663
    // reco-> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_unfolding/UL18/electron/workdir_Analysis_UL18_unfolding_electron_new/nominal/uhh2.AnalysisModuleRunner.TTToSemiLeptonic1.root");
    // reco-> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_unfolding/UL18/electron/workdir_Analysis_UL18_unfolding_electron_new/nominal/uhh2.AnalysisModuleRunner.TTToSemiLeptonic2.root");
    // reco-> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_unfolding/UL18/electron/workdir_Analysis_UL18_unfolding_electron_new/nominal/uhh2.AnalysisModuleRunner.TTToSemiLeptonic3.root");
    
    // UL 17 Electron 14239421
    // reco-> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_unfolding/UL17/electron/workdir_Analysis_UL17_unfolding_electron/nominal/uhh2.AnalysisModuleRunner.TTToSemiLeptonic1.root");
    // reco-> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_unfolding/UL17/electron/workdir_Analysis_UL17_unfolding_electron/nominal/uhh2.AnalysisModuleRunner.TTToSemiLeptonic2.root");
    // reco-> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_unfolding/UL17/electron/workdir_Analysis_UL17_unfolding_electron/nominal/uhh2.AnalysisModuleRunner.TTToSemiLeptonic3.root");
    
     //UL 16preVFP Electron 5294539
    // reco-> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_unfolding/UL16preVFP/electron/workdir_Analysis_UL16preVFP_unfolding_electron/nominal/uhh2.AnalysisModuleRunner.TTToSemiLeptonic1.root");
    
    //UL 16postVFP Electron 6158510
    reco-> Add("/nfs/dust/cms/user/beozek/uuh2-106X_v2/CMSSW_10_6_28/src/UHH2/ZprimeSemiLeptonic/output_unfolding/UL16postVFP/electron/workdir_Analysis_UL16postVFP_unfolding_electron/nominal/uhh2.AnalysisModuleRunner.TTToSemiLeptoni1.root");
    ...
    TFile* myFile = new TFile("DeltaY_UL16postVFP_electron.root", "RECREATE");
   ...
   //// ===== CANVAS =====
    ...
    Matrix->Draw("colz");
    dd->Print("ResponseMatrix_UL16postVFP_electron.pdf");
